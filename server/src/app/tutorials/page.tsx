            ...
            <main className='container mx-auto flex grow gap-8'>
                ...
                <div className='flex flex-1 shrink-0 grow flex-col'>
                    <div className='flex flex-col gap-4 py-16'>
                        ...
                        <p>After following these tutorials, you may practice with the virtual robot in HANDZONe or visit <a href="https://www.tudelft.nl/bk/onderzoek/bk-labs/lama" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline">LAMA</a> (Laboratory for Additive Manufacturing in Architecture) at TU Delft Faculty of Architecture and the Built Environment to develop hands-on skills.</p>
                        <a href="https://digipedia.tudelft.nl/subject/ur5-tutorials/?tab=chapter-0" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline">Click here to access the tutorials on DigiPedia.</a>
                    </div>
                </div>
            </main>
        </div>
